...
_lr_productions = [
  ...
  ('expression -> expression AND expression','expression',3,'p_expression_binary','parser.py',47),
  ('expression -> expression OR expression','expression',3,'p_expression_binary','parser.py',48),
  ('expression -> expression IMPLIES expression','expression',3,'p_expression_binary','parser.py',49),
  ('expression -> COALITION expression UNTIL expression','expression',4,'p_expression_ternary','parser.py',58),
  ('expression -> COALITION GLOBALLY expression','expression',3,'p_expression_unary','parser.py',67),
  ('expression -> COALITION NEXT expression','expression',3,'p_expression_unary','parser.py',68),
  ('expression -> COALITION EVENTUALLY expression','expression',3,'p_expression_unary','parser.py',69),
